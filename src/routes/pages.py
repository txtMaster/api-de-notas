...
from ..utils.security import create_serialized, get_serializer, try_verify_daily_serialized, try_verify_hourly_serialized
...
def verify_user():
   ...
   error,token_data = try_verify_hourly_serialized(token,Config.SALT)
